...
const CATEGORY_NAME = "MAKARNALAR";
const PRINTER_ROUTE = "MUTFAK";

const ITEMS = [
  { name: "Penne Arrabbiata", price: 250.0 },
  { name: "Penne Alfredo", price: 290.0 },
  { name: "Spagetti Napoliten", price: 250.0 },
  { name: "Spagetti Bolognese", price: 300.0 },
  { name: "Fettuccine Alfredo", price: 320.0 },
  { name: "Mantı", price: 300.0 },
];
...
async function run() {
  ...
  try {
    ...
    console.error("MAKARNALAR seed hatasi:", error);
    process.exitCode = 1;
  } finally {
    client.release();
    await db.pool.end();
