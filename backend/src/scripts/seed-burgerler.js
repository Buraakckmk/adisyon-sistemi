...
const CATEGORY_NAME = "BURGERLER";
const PRINTER_ROUTE = "MUTFAK";

const ITEMS = [
  { name: "Cheese Burger", price: 350.0 },
  { name: "Cheese Mushroom Burger", price: 520.0 },
  { name: "Big Chicken", price: 280.0 },
  { name: "Klasik Usul Burger", price: 320.0 },
];
...
async function run() {
  ...
  try {
    ...
    console.error("BURGERLER seed hatasi:", error);
    process.exitCode = 1;
  } finally {
    client.release();
    await db.pool.end();
