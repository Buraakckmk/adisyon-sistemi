...
const CATEGORY_NAME = "ANA YEMEKLER";
const PRINTER_ROUTE = "MUTFAK";

const ITEMS = [
  { name: "Köri Soslu Tavuk", price: 350.0 },
  { name: "Soya Soslu Tavuk", price: 350.0 },
  { name: "Piliç Şinitzel", price: 330.0 },
  { name: "Tavuklu Fajita", price: 400.0 },
  { name: "Beşamel Soslu Tavuk", price: 350.0 },
  { name: "Tavuk Izgara", price: 350.0 },
  { name: "Acılı Kanat", price: 495.0 },
  { name: "Chef Köfte", price: 350.0 },
  { name: "Chef Köfte Kaşarlı", price: 380.0 },
  { name: "Bodrum Çökertmesi", price: 600.0 },
  { name: "Gurme Bonfile", price: 700.0 },
  { name: "Etli Fajita", price: 700.0 },
  { name: "Güveçte Et Sote", price: 550.0 },
  { name: "Steak Rulo", price: 700.0 },
];
...
async function run() {
  ...
  try {
    ...
    console.error("ANA YEMEKLER seed hatasi:", error);
    process.exitCode = 1;
  } finally {
    client.release();
    await db.pool.end();
