...
class _AdvancedPaymentDialogState extends State<AdvancedPaymentDialog> {
  ...
  void initState() {
    ...
    final initialCollected = roundMoney(
      widget.initialCollectedAmount.clamp(0, widget.totalAmount).toDouble(),
    );
    discountController = TextEditingController(
      text: initialDiscount > 0 ? initialDiscount.toStringAsFixed(2) : "",
    );

    final initialPayable = roundMoney(widget.totalAmount - initialDiscount);
    final initialRemaining = roundMoney(initialPayable - initialCollected);
